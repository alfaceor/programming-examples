...
/*				std::cout<<i<<std::endl;
    ...
    void print2debug(){
      ...
      std::cout << "memory_layer_ptr[0] : " << *memory_layer_ptr << std::endl;
      std::cout << "value_ptr_arr[0]    : " << *value_ptr_arr    << std::endl;
      for(size_t i = 0 ; i!=range ; ++i){
				std::cout << "memory_layer_ptr[" <<i<<"] : " << this->memory_layer_ptr[i] << std::endl;
			}
      for(size_t i = 0 ; i!=range ; ++i){
				std::cout << "value_ptr_arr[" <<i<<"] : " << this->value_ptr_arr[i] << std::endl;
			}
    }
