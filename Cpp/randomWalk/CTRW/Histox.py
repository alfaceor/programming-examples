...
strMuList = ["0.5" , "1.0", "1.5", "2.0", "3.0", "4.0"]
strMuList = ["0.5", "1.0", "1.5", "4.0"]
strMuList = ["0.5", "0.6", "0.7", "0.8", "0.9", "1.0", "1.1", "1.2" ] #, "1.5", "4.0"]
for im in range(len(strMuList)):
  strMu = strMuList[im]
  lblMu = "$"+ strMu +"$"

  data = np.loadtxt("histox_mu_"+strMu+".dat")
  ...
  ax.plot( bins, rndfloat, marker="o", linestyle="solid", color=colorcito, label=lblMu) #+lblMuFit)
  #print rndfloat
